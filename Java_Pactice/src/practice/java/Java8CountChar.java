...
public class Java8CountChar {
	...
	public static void main(String[] args) {
		...
		res.forEach((letter,count)->System.out.println(letter+":"+count));
		...
		res1.forEach((letter,count)->System.out.println(letter+":"+count));
		...
		res2.forEach((letter,count)->System.out.println(letter+":"+count));
		
		System.out.println("result with only characters ignoring special char, numbers in sorted order");
		res2.entrySet().stream().sorted(Map.Entry.comparingByKey()).forEach(entry->System.out.println(entry.getKey()+":"+entry.getValue()));
		...
		res3.entrySet().stream().sorted(Map.Entry.comparingByKey()).forEach(entry->System.out.println(entry.getKey()+":"+entry.getValue()));
	}
